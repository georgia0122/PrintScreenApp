namespace PrintScreenApp
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            labelTitle.Size = new Size(120, 35);
            labelTitle.TabIndex = 10;
            labelTitle.Text = "截图工具";
            
            // 
            // labelHotkey
            // 
            labelHotkey.AutoSize = true;
            labelHotkey.Font = new Font("微软雅黑", 10F, FontStyle.Regular);
            ...
            labelHotkey.Text = "快捷键: Ctrl + Alt + A";
            ...
            button1.Font = new Font("微软雅黑", 11F, FontStyle.Bold);
            ...
            button2.Font = new Font("微软雅黑", 11F, FontStyle.Bold);
            ...
            button3.Font = new Font("微软雅黑", 11F, FontStyle.Bold);
